...
* Two icons with similar elements should use similar wordage.
  * E.g. <img src="https://pinhead.ink/latest/campsite_above_water.svg" height="15px" width="15px"/> `campsite_above_water` uses parallel language to <img src="https://pinhead.ink/latest/skull_above_water.svg" height="15px" width="15px"/> `skull_above_water` rather than something like "capsite_over_waves"
